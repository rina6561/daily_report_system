...
/**
 * 従業員データのDTOモデル（データベースの情報を保持する）
 *
 */

//Q_EMP_GET_ALL：すべての従業員情報を取得、Q_EMP_COUNT：従業員情報の全件数を取得
//Q_EMP_GET_BY_CODE_AND_PASS ：従業員がログインするときに社員番号とパスワードが正しいかをチェック
//Q_EMP_COUNT_REGISTERED_BY_CODE ：指定された社員番号がすでにデータベースに存在しているかを調べる
...
public class Employee {
     ...
     * 社員番号
     */
    //unique = true：一意制約といい、すでに存在している社員番号は登録できない旨をデータベースに指定するための設定
